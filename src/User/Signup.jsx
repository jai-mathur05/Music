...
const Signup = () => {
  ...
  return (
    ...
    <h2 style={{ position: "relative", bottom: "300px", right: "300px", transform: "scaleX(-1.5)",}} > <Link to="/" className='text-gray-500 hover:text-gray-900'><FaSignOutAlt/></Link></h2>
      ...
      <div className="relative  bg-pink-700 p-8 rounded-md shadow-md overflow-hidden" style={{display:"flex",height:"440px",width:"550px"}}>
      <div>
        <img src='https://play-lh.googleusercontent.com/0b5u0v9Jo6agmcP2wOeKjWX7JIOHuwO9FaHhUK4GITc9iaUY7Xiw9gQrsfzIYA7RqKY' width='200px' style={{marginRight:"35px",height:"390px"}} />
      </div>
